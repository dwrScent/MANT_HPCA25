...
TASKS=${2:-"wikitext"}
SHOTS=${3:-"0"}
# QUANT_MODE=${4:-"metaflint"}
QUANT_MODE=${4:-"ant"}
QUANT_DTYPE=${5:-"int-flint-pot"}
GROUP_SIZE=${6:-"16"}
QUANT_BIT_WIDTH=${7:-"w4a4k16v16"}
DESC=${8:-""}

# MODEL=meta-llama/Llama-2-${MODEL_SIZE}b-hf
MODEL=/cephfs/shared/model/llama-2-${MODEL_SIZE}b-hf

OUTPUT_NAME=llama2-${MODEL_SIZE}b
OUTPUT_DIR=output/output_llama2
